...
def main_window():
    ...
    pygame.display.set_caption('COLOBOK MASTER')
    ...
    while running:
        ...
        show_message(screen, 'COLOBOK MASTER', (50, 10),
                     30)
        show_message(screen, 'click space to start the game', (180, 610),
                     30)
        pygame.display.flip()
        clock.tick(FPS)
...
def game_window():
    ...
    pygame.display.set_caption('COLOBOK')
    icon = pygame.image.load('images/colobok.png')
    pygame.display.set_icon(icon)
    ...
    while running:
        ...
        game.render(screen)
        show_message(screen, f'SCORE: {score}', (0, 0), 25)
        if game.check_lose():
            pygame.mixer.music.stop()
            game_over = True
            show_message(screen, 'GAME OVER', (320, 300), 50)
            show_message(screen, 'Click R to restart the game', (220, 370), 25)
        pygame.display.flip()
        clock.tick(FPS)
